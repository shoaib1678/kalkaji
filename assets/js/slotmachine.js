...
(function() {
    ...
    3: [function(require, module, exports) {
        ...
        var defaults = {
            ...
            auto: false,
            // Repeat delay [false||Number]
            spins: 1,
            // Number of spins when auto [Number]
            randomize: null,
            // Randomize function, must return a number with the selected position
            onComplete: null,
            // Callback function(result)
            inViewport: false,
            // Stops animations if the element isn´t visible on the screen
            direction: 'up',
                ...
                set: function set(FX_SPEED) {
                    ...
                    raf(function() {
                        ...
                        if (FX_SPEED === FX_STOP) {
                            ...
                            document.getElementById("wheel2").className = "spin-wheel ball";
                        } else {
            ...
            _createClass(Timer, [{
                ...
                value: function _start() {
                    ...
                    this.timer = setTimeout(function() {
                        document.getElementById("wheel3").className = "spin-fast ball";
                        _this.running = false;
                        _this.cb(_this);
                    }, this.delay);
                }
